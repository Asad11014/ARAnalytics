...
export default function Sidebar() {
  ...
  return (
    <aside className={clsx(
      ...
      {/* Logo + mobile close button — always at top */}
      <div className="px-5 py-5 border-b-2 border-primary flex items-center gap-3 flex-shrink-0">
        ...
        <button
          ...
          className="lg:hidden w-7 h-7 flex items-center justify-center text-ink-muted hover:text-ink hover:bg-brand-surface2 rounded transition-colors text-base"
        >
          ✕
        </button>
      </div>

      {/* Scrollable middle: selectors + nav */}
      ...
      {/* Footer — always pinned at the bottom, never scrolls away */}
      <div className="flex-shrink-0 px-4 py-4 border-t border-brand-border">
